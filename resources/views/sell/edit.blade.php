    ...
    <div id="termsModal" class="modal">
      ...
      <form method="post"  action="/sell/{{ $product->id }}" enctype="multipart/form-data" id="myForm">
        ...
        <div class="form-floating mb-3 mt-3">
            ...
            <input type="text" name="product_name" class="form-control @error('product_name') is-invalid @enderror" id="product_name" placeholder="Item Name" required value="{{ old("product_name", $product->product_name) }}" maxlength="255" style="text-transform: capitalize;">
            @error('product_name')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="row mt-3">
            ...
            <select class="form-select mb-3 mt-3" aria-label="Default select example" name="condition_id" id="condition_id" required>
                ...
                @foreach( $conditions as $condition)
                    ...
                    @if(old('condition_id' ,$product->condition_id) == $condition->id)
            ...
            <div class="pricing mb-3 mt-3">
                ...
                <select class="form-select mb-3 mt-3" aria-label="Default select example" name="option_id" id="option_id" required  >
                    ...
                    @foreach($selleroptions as $selleroption)
                        @if(old('selleroption_id',  $product->selleroption_id) == $selleroption->id)
            ...
            <div class="inp_price mb-3 mt-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="product_price" class="form-control @error('price') is-invalid @enderror" id="product_price" aria-label="Text input with dropdown button" required value="{{ old("product_price", $product->product_price) }}">
                        @error('product_price')
                            <div class="invalid-feedback">
                             {{ $message }}
                            </div>
                        ...
                        <select class="form-select" name="nego_id" id="inputGroupSelect01" required value="{{ old("nego_id") }}">
                            @foreach($negos as $nego)
                                @if(old('nego_id',  $product->nego_id) == $nego->id)
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="brand" class="form-control @error('brand') is-invalid @enderror" id="brand" required value="{{ old("brand",  $product->brand) }}" maxlength="255">
                  @error('brand')
                  <div class="invalid-feedback">
                   {{ $message }}
                  </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="material" class="form-control @error('brand') is-invalid @enderror" id="material" required value="{{ old("material", $product->material) }}" maxlength="255">
                  @error('material')
                  <div class="invalid-feedback">
                   {{ $message }}
                  </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text"   name="description" class="form-control" id="description" value="{{ old("description",  $product->description) }}" maxlength="255">
                </div>
            </div>
            ...
            <div class="meetup">
                <h6>Meet-Up Point</h6>
                <div class="col-12">
                    <input type="text" name="meetup_point" class="form-control @error('meetup_point') is-invalid @enderror"  id="meetup_point" placeholder="KICT" required value="{{ old("meetup_point",  $product->meetup_point) }}" maxlength="255">
                    @error('meetup_point')
                    <div class="invalid-feedback">
                     {{ $message }}
                    </div>
