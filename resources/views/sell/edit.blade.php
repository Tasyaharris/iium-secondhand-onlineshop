    ...
    <form method="post" action="/sell/{{ $product->id }}" enctype="multipart/form-data" id="myForm">
        ...
        @csrf
            ...
            <div class="form-floating mb-3 mt-3">
                ...
                <input type="product_name" name="product_name" class="form-control @error('product_name') is-invalid @enderror" id="product_name" placeholder="Item Name" required  value="{{ old("product_name", $product->product_name) }}" maxlength="255">
                @error('product_name')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="brand" name="brand"  class="form-control @error('brand') is-invalid @enderror" id="brand" required value="{{ old("brand" , $product->brand) }}" maxlength="255">
                  @error('brand')
                  <div class="invalid-feedback">
                   {{ $message }}
                  </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="material"  name="material" class="form-control @error('brand') is-invalid @enderror" id="material" required value="{{ old("material", $product->material) }}" maxlength="255">
                  @error('material')
                  <div class="invalid-feedback">
                   {{ $message }}
                  </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="description"   name="description" class="form-control" id="description" value="{{ old("description", $product->more_desc) }}" maxlength="255">
                </div>
            </div>
            ...
            <div class="meetup">
                <h6>Meet-Up Point</h6>
                <div class="col-12">
                    <input type="text" class="form-control @error('meetup_point') is-invalid @enderror" name="meetup_point" id="meetup_point" placeholder="KICT" required value="{{ old("meetup_point", $product->meetup_point) }}" maxlength="255">
                    @error('meetup_point')
                    <div class="invalid-feedback">
                     {{ $message }}
                    </div>
