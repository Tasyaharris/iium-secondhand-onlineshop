...
<body>
    ...
    <div class="order-desc">
        ...
        <nav style="height: auto;border: 1px solid #000; ">
            ...
            <nav style="border: 1px solid #000;height:auto;">
                 ...
                 @endforeach 
                    ...
                    <div style="text-align: left;">
                        <h6 style="margin-top:10px;">Total Order: RM {{ $order_item->order->totalOrder}}</h6>
                    </div>
                    </div>
                </div>
            </nav>
    ...
    <nav class="navbar navbar-expand-lg " style="height: auto;border: 1px solid #000;">
        <div  style="margin-left:30px;display:flex;align-items:center;">
          ...
          <textarea class="form-control mt-3" id="comment" name="comment" placeholder="Type comment here" style="height: 50px;border:none;margin-left:7px;width:1100px;"></textarea>
        </div>
    </nav>
