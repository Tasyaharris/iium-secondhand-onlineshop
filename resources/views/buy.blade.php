  ...
  <body>
    ...
    <nav class="navbar bg-body-tertiary border-bottom mt-0" style="height: 100px;border: 1px solid #000;">
        <div class="address1" style="display: inline-block;margin-left:30px;">
            ...
            <a href="/homepage" class="p-3 text-decoration-none d-inline" style="font-weight: bold; color: black;">Address</a>
            </div>
            <div style="text-align: center;">
              <small>address</small>
            </div>
    ...
    <nav class="navbar bg-body-tertiary border-bottom mt-0" style="height: 50px;border: 1px solid #000;">
        <div class="address1" style="display: inline-block;margin-left:30px;">
            ...
            <a href="/homepage" class="p-3 text-decoration-none d-inline" style="font-weight: bold; color: black;">User</a>
            </div>
            <div style="text-align: center;">             
            </div>
        </div>
     ...
     <!--product detail-->
     <nav class="navbar  border-bottom mt-0" style="height: 250px;border: 1px solid #000;">
