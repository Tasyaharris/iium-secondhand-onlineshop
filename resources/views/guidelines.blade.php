...
<body >
    ...
    <h4 style="text-align: center;margin-top:30px;margin-bottom:30px;">WELCOME TO  IIUM SECOND-HAND ONLINE SHOP</h4>
     ...
     <p>Users are required to register on the platform before listing or purchasing items. It is strongly recommended to complete detailed profiles to provide comprehensive information to potential buyers. Additionally, registering bank account details is highly suggested to broaden the range of payment methods available to buyers.</p>
     <p>We assure users that their bank account information is secure and will only be used for transaction processes.</p>
     
     <h4>Product Listing</h4>
     <p>List your second-hand items for sale by clicking the designated button, which will direct you to the listing page.</p>
     ...
     <ul>
         ...
         <li>Refer to provided guidelines or the following link when determining the condition of your product.</li>
     ...
     <ul>
         <li>We provide a community forum for users to engage in discussions related to our system.</li>
...
<p>If you encounter any issues, have concerns, or wish to provide feedback regarding the system, feel free to contact the administrator directly. Use the "Contact Admin" feature or send an email to admin@[yourwebsite].com. We are here to assist you and ensure a smooth experience for all users.</p>
     ...
     <p>Stay informed about platform updates, new features, and important announcements through our notifications. Regularly check your account for messages and updates to ensure a smooth experience.</p>
