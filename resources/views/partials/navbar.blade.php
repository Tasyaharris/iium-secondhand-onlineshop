  ...
  <div class="container-fluid">
    ...
    <form action="/sell" class="d-flex" role="search">
      ...
      <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
          @auth
              <a href="{{ url('/sell/index') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Sell</a>
          @else
