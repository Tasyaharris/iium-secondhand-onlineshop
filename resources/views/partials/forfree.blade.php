...
<section class="explore border-bottom mt-0" id="explore" style="background-color: white; height: 400px;">
  <div class="max-width">
    <div class="explore-content">
      ...
      <div id="carouselExampleFade1" class="carousel slide" style="height: 350px;">
        <div class="carousel-inner">
            @foreach ($products->chunk(4) as $chunk)
                <div class="carousel-item{{ $loop->first ? ' active' : '' }}">
                    <div class="carousel1" href="/products.viewproduct" id="myCarousel1">
        ...
        <button class="carousel-control-prev custom-prev" type="button" data-bs-target="#carouselExampleFade1" data-bs-slide="prev">
        ...
        <button class="carousel-control-next custom-next" type="button" data-bs-target="#carouselExampleFade1" data-bs-slide="next">
