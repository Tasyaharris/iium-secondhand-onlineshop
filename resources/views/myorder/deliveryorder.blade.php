                    ...
                    <div class="col">       
                        ...
                        <div class="card  text-center " style="width: 670px; height: auto;">
                            ...
                            <div style="text-align: left;">
                              ...
                              <div class="card text-center d-flex flex-column " style="width: 670px; height: auto;margin-top:0; margin-left:0px;display:flex; ">
                                <small style="text-align:left; margin-left:10px;margin-top:10px;">Order has been received</small>
                                <a class="processBtn ms-auto" href="{{ url('prepare', $order_item->order->id) }}"  style="margin-right:15px;border-radius: 5px; border: 1px solid #000;background: rgba(168, 184, 208, 0.80);  width:130px; display:flex; text-align:center; justify-content:center;text-decoration: none; color:black; height:30px; width:80px; margin-bottom:10px;">Rate</a> 
                              </div>
                          </div>
                        </div>
