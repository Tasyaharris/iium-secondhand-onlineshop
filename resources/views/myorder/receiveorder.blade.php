                ...
                @foreach($order_items->groupBy('order.id') as $orderId => $orderGroup)
                    <div class="col">       
                        ...
                        <div class="card  text-center " style="width: 670px; height: auto;">
                            ...
                            <a class="processBtn ms-auto" href="{{ url('receivedbuyer', $order_item->order->id) }}"  style="margin-right:15px;border-radius: 5px; border: 1px solid #000;background: rgba(168, 184, 208, 0.80);  width:130px; display:flex; text-align:center; justify-content:center;text-decoration: none; color:black; height:30px; width:140px; margin-bottom:10px;">Order received</a> 
                          </div>
                        </div>
