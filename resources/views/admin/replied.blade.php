    ...
    <div class="table-container"  >
        <table class="selection" style=" margin:0;padding:0;   background-color: white; text-align: center;">
            <tr style=" background-color: white; text-align: center;">
              <td class="clickable-row {{ Request::is('recent') ? 'active' : ' ' }}"  data-href="/adminmessage" style=" padding: 10px;border: 1px solid black;width: 185px;">
                <a href="/adminmessage" style="color: black; text-decoration:none;">Recent</a>
              </td>
              <td class="clickable-row active  {{ Request::is('yourdiscussion') ? 'active' : ' ' }}" data-href="/yourdiscussion" style=" padding: 10px;border: 1px solid black;width: 185px;">
